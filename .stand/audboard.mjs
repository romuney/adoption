...
const page = '<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;background:#f6f6f6;font-family:Inter,Arial}'
  ...
  + (process.env.TABS ? '<div class="full dashboard-component-tabs"><div class="ant-tabs ant-tabs-top ant-tabs-card"><div class="ant-tabs-nav" role="tablist"><div class="ant-tabs-nav-wrap"><div class="ant-tabs-nav-list">'
