...
const page = '<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;background:#f6f6f6;font:13px Arial}'
  + '.grid-row{display:flex;gap:16px;padding:8px 16px}.dashboard-component-chart-holder{flex:1;background:#fff;border-radius:12px;overflow:hidden}'
  ...
  + '<div class="chart-container"><div class="slice_container"><div class="react_sanbbox"><iframe sandbox="allow-scripts" id="fr"></iframe></div>'
