...
|---|---|---|
| Вкладки | 26 (tiny 22) | подложка padding 3 (tiny 2), gap 3, радиус 12/9; счётчик-бейдж внутри высоту не меняет |
| Пилюля фильтра | 24 | padding 0 10, с × — справа 5; gap между пилюлями 6 |
| Переключатель шапки | 30 | ползунок 26 × 15 |
| Сегмент периода | ~26 | padding 5 12, радиус 7 внутри подложки 9 |
