...
- **Серии данных:** новые `#0073A0`, вернувшиеся `#AA77FF`, продолжающие `#5CC0EE`,
  просмотры `#5b6478`.
- **Корзины частоты:** пять ступеней от светлого к тёмному: `#c3e6f7 #8fd0ea
  #5cc0ee #2ba8c6 #0073a0`.
- **Когорты:** дивергентная шкала «жёлтый `#FFD758` ↔ белый ↔ голубой `#62CDFF`»,
...
| Акцент `--act:#2b6cff` | `#0073A0` + `act-ink`, `act-line` | фирменный тон Proteus, совпадает с «новыми» на графике |
