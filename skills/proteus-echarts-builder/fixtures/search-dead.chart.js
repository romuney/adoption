...
//
// ЗАШИТЫЙ БАГ: поповер открывается, поле поиска в нём есть, но обработчик
// события input не навешен — ввод не фильтрует список. E23 обязан упасть,
// E23b — пройти (каретку никто не сбивает: DOM не пересобирается).
...
function buildHTML() {
  ...
  // поле поиска без обработчика input — зашитый баг E23
