...
// pa_dicts нужен только чтобы чарт существовал (лимит 1). Эмиты читает
// джиня куба v6 / когорт / pa_who (паттерн 59922, носители не в SELECT).
var CFG = {
  ns: 'past',
  ...
  tips: {
    optsTrg: { title: 'Опции',
      text: 'Свитки качества отчётов. Период — слева; фильтры по людям — кликами по строкам «Кто смотрит»; отчётные условия — выбором в каталоге.' }
  },
  colors: {
