...
(function (global) {
  ...
  const CUTS = {
    ...
    lvl3:   { label: 'Управл. структура, ур. 3', vals: ['Розница', 'Технологии', 'Корпоративный', 'Риски', 'Финансы', 'Операции', 'Люди'], w: [24, 21, 14, 12, 10, 12, 7] },
  ...
  const ORG_TREE = {
    'Розница':        [['Департамент продаж', 11], ['Департамент отделений', 8], ['Департамент маркетинга', 5]],
    'Технологии':     [['Департамент разработки', 11], ['Департамент данных', 6], ['Департамент инфраструктуры', 4]],
    'Корпоративный':  [['Департамент корпоративных продаж', 9], ['Департамент МСБ', 5]],
    'Риски':          [['Департамент кредитных рисков', 7], ['Департамент безопасности', 5]],
    'Финансы':        [['Департамент казначейства', 6], ['Департамент отчётности', 4]],
    'Операции':       [['Департамент поддержки', 7], ['Департамент логистики', 5]],
  ...
  /* ----------------------------------------------------------------------
     ...
     -------------------------------------------------------------------- */
  const AD_GROUP_DEF = {
    proteus_retail_analytics: { home: 'Розница', pIn: .52, pOut: .03 },
    proteus_risk_all:         { home: 'Риски', pIn: .68, pOut: .02 },
    proteus_finance_core:     { home: 'Финансы', pIn: .61, pOut: .02 },
    proteus_tech_dept:        { home: 'Технологии', pIn: .64, pOut: .02 },
    proteus_msb_sales:        { home: 'Корпоративный', pIn: .49, pOut: .03 },
    proteus_support_leads:    { home: 'Операции', pIn: .33, pOut: .015 },
  ...
  const population = (function buildPopulation() {
    ...
    const seenLg = {};
    out.forEach((p) => {
      const n = (seenLg[p.login] = (seenLg[p.login] || 0) + 1);
      if (n > 1) p.login += n;
    });
    return out;
  })();
